...
Contributors: wordpressarena, wparena
...
SEO WP includes support for Infinite Scroll in Jetpack.
...
a2) Materialize
Resource URI: http://materializecss.com/
Copyright: Alvin Wang
License: MIT
...
b1) Material Design icons
Copyright: Google
Resource URI: http://google.github.io/material-design-icons/
...
* Resolved issue of menu on small screens

= 2.3.10 =
* Released: January 16 , 2018
* Resolved Image Height Issue In Single Post Per Row Format
* Add Functinality Of Color Contrast for Caret Signs
* Remove BreadCrum for unwanted Pages
...
* Resolved Pagination Issue
* Adjusted Link colors
* Some Work With CSS Styles

= 2.3.4 =
* Released: January 11 , 2018
* Resolved The Dropdown Issue
* Added Materlize Icons
...
* Fixed Footer Widgets Issue (Not displaying).
* Fixed Some css
...
* Fixed bug for compatibility with CloudFlare.
